...
Ext.ux.form.SuperBoxSelect = function (config) {
    config.listClass = 'x-superboxselect-list';
...
Ext.ux.form.SuperBoxSelect = Ext.extend(Ext.ux.form.SuperBoxSelect, Ext.form.ComboBox, {
    ...
    initComponent: function () {
        ...
        if (this.forceFormValue) {
            this.store = Bendera.templateList['templates']

/*
            if(this.context == 'web'){
                //conosle.log('web');
                this.store = Bendera.resourceList['web']
            }
        	if(this.context == 'web'){
                //conosle.log('web');
                this.store = Bendera.resourceList['web']
            ...
            if(this.context == 'DE'){
                //conosle.log('web');
                this.store = Bendera.resourceList['DE']
            }
            if(this.context == 'EN'){
                //conosle.log('web');
                this.store = Bendera.resourceList['EN']
            }
*/
            this.items.on({
    ...
    onRender: function (ct, position) {
        ...
        this.outerWrapEl = this.wrapEl.wrap({
            ...
            //cls: 'x-superboxselect ' + extraClass
        });
    ...
    addItem: function (newItemObject, forcedAdd) {
    ...
    setValueEx: function (data) {
        ...
        this.remoteLookup = [];
        if (this.allowAddNewData && this.mode === 'remote') {
    ...
    onDestroy: function () {
        ...
        if (this.renderFieldBtns) {
            Ext.destroy(this.buttonClear, this.buttonWrap)
        }
